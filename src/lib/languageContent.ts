...
export const LANGUAGE_CONTENT: Record<string, Record<string, string>> = {
  ...
  nv: { hello: 'Yáʼátʼééh', goodbye: 'Hágoóneeʼ', thank_you: 'Ahéheeʼ', please: 'Tʼáá shǫǫdí', yes: 'Aooʼ', no: 'Dooda', good_morning: 'Yáʼátʼééh abíní', good_night: 'Yáʼátʼééh', how_are_you: 'Nizhónígo?', im_fine: 'Nizhóní', my_name_is: 'Shí éí...', nice_to_meet_you: 'Ayóóʼánóshní', excuse_me: 'Shił aheeheeʼ', sorry: 'Bik'eh', water: 'Tó', food: 'Ch'iyáán', help: 'Shíká anílyeed', where_is: 'Háádish...?', how_much: 'Díkwíí?', i_dont_understand: 'Doo shił bééhózin da' },
